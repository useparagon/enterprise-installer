<table header-row="true">
	...
	<tr>
		<td>Dashboard</td>
		<td>[https://dashboard.integration.r2.isms.online](https://dashboard.integration.r2.isms.online)</td>
	</tr>
	<tr>
		<td>Grafana</td>
		<td>[https://grafana.integration.r2.isms.online](https://grafana.integration.r2.isms.online) (shared creds in 1Password)</td>
	</tr>
</table>
...
<details>
<summary>Thu Jui 17, 2025</summary>
	- upgraded app to `2025.0715.0855-f1f9fa5d`
	- patched hpa replication limit 
		```
...
<summary>Thu Nov 13, 2025</summary>
	...
	global:
	  env:
	    ...
	    CLOUD_STORAGE_PUBLIC_URL:             https://s3.ap-southeast-2.amazonaws.com
	    CLOUD_STORAGE_PRIVATE_URL:            https://s3.ap-southeast-2.amazonaws.com
	    CLOUD_STORAGE_PUBLIC_BUCKET:          paragon-enterprise-isms-ap-cdn
	    CLOUD_STORAGE_SYSTEM_BUCKET:          paragon-enterprise-isms-ap
	    CLOUD_STORAGE_MICROSERVICE_PASS:      <redacted>
	    CLOUD_STORAGE_MICROSERVICE_USER:      <redacted>
	    CLOUD_STORAGE_REGION:                 ap-southeast-2
