...
| <a name="input_agent_os_extract_instance_types"></a> [agent\_os\_extract\_instance\_types](#input\_agent\_os\_extract\_instance\_types) | Compute-optimized AMD EC2 instance types for the Agent OS Karpenter extraction pool. | `list(string)` | <pre>[<br/>  "c6a.4xlarge"<br/>]</pre> | no |
| <a name="input_agent_os_extract_max_count"></a> [agent\_os\_extract\_max\_count](#input\_agent\_os\_extract\_max\_count) | Maximum nodes in the Agent OS Karpenter extraction pool. Use 3 for staging and 8 for production; Karpenter scales to zero when idle. | `number` | `8` | no |
| <a name="input_agent_os_index_instance_types"></a> [agent\_os\_index\_instance\_types](#input\_agent\_os\_index\_instance\_types) | Memory-optimized EC2 instance types for the Agent OS Karpenter index pool. | `list(string)` | <pre>[<br/>  "r6a.2xlarge",<br/>  "r6i.2xlarge",<br/>  "r5a.2xlarge"<br/>]</pre> | no |
| <a name="input_agent_os_index_max_count"></a> [agent\_os\_index\_max\_count](#input\_agent\_os\_index\_max\_count) | Maximum nodes in the Agent OS Karpenter index pool. Karpenter intentionally scales the pool to zero when idle. | `number` | `4` | no |
